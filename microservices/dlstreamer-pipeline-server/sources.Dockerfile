...
FROM intel/dlstreamer-pipeline-server:2026.2.0-extended-ubuntu22-rc3 AS ubuntu22-builder
...
FROM intel/dlstreamer-pipeline-server:2026.2.0-extended-ubuntu24-rc3 AS ubuntu24-builder
